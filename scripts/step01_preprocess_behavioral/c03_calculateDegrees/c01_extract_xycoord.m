...
for i = 1:length(sub)
    for ses = 1:length(session)
        for task = 1:3
            d01_behavioral_dir = fullfile('/Users/h/Documents/projects_local/social_influence_analysis/data/dartmouth/d01_rawbeh/', ['sub-', sprintf('%04d', sub(i))], ['ses-', sprintf('%02d', session(ses))]);
            d02_behavioral_dir = fullfile('/Users/h/Documents/projects_local/social_influence_analysis/data/dartmouth/d02_preprocessed/', ['sub-', sprintf('%04d', sub(i))], ['ses-', sprintf('%02d', session(ses))]);
