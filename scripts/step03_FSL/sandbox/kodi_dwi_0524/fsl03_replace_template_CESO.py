...
for sub, ses_num, run_num in b:
    ...
    if ev_top_dir:
        ...
        for ev_folder in sorted(ev_list):
            ...
            new_fsf_template = new_fsf_template.replace('EV_CUEFNAME', single_title)
            new_fsf_template = new_fsf_template.replace('EV_EXPECTFNAME', single_fname)
            new_fsf_template = new_fsf_template.replace('EV_STIMFNAME', combine_title)
            new_fsf_template = new_fsf_template.replace('EV_OUTCOMEFNAME', combine_fname)
