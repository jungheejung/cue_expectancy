...
% if TTL file doen't exist, use average rampup and rampdown for specific stimulu
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(1).name = 'STIM_cue-high_stim-high';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(1).onset = double(cue.plateau_onset(highcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(1).duration = double(repelem(5, length(double(cue.plateau_onset(highcue(:,1) & highstim(:,1)))))');
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(2).name = 'STIM_cue-high_stim-high_rampup';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(2).onset = double(cue.rampup_onset(highcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(2).duration = double(cue.rampup_dur(highcue(:,1) & highstim(:,1)));
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(3).name = 'STIM_cue-high_stim-high_rampdown';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(3).onset = double(cue.rampdown_onset(highcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(3).duration = double(cue.rampdown_dur(highcue(:,1) & highstim(:,1)));
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(4).name = 'STIM_cue-high_stim-med';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(4).onset = double(cue.plateau_onset(highcue(:,1) & medstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(4).duration = double(repelem(5, length(double(cue.plateau_onset(highcue(:,1) & medstim(:,1)))))');
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(5).name = 'STIM_cue-high_stim-med_rampup';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(5).onset = double(cue.rampup_onset(highcue(:,1) & medstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(5).duration = double(cue.rampup_dur(highcue(:,1) & medstim(:,1)));
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(7).name = 'STIM_cue-high_stim-low';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(7).onset = double(cue.plateau_onset(highcue(:,1) & lowstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(7).duration = double(repelem(5, length(double(cue.plateau_onset(highcue(:,1) & lowstim(:,1)))))');
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(8).name = 'STIM_cue-high_stim-low_rampup';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(8).onset = double(cue.rampup_onset(highcue(:,1) & lowstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(8).duration = double(cue.rampup_dur(highcue(:,1) & lowstim(:,1)));
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(9).name = 'STIM_cue-high_stim-low_rampdown';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(9).onset = double(cue.rampdown_onset(highcue(:,1) & lowstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(9).duration = double(cue.rampdown_dur(highcue(:,1) & lowstim(:,1)));
...
% cond 4 : STIM_cue-low_stim-high
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(10).name = 'STIM_cue-low_stim-high';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(10).onset = double(cue.plateau_onset(lowcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(10).duration = double(repelem(5, length(double(cue.plateau_onset(lowcue(:,1) & highstim(:,1)))))');
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(11).name = 'STIM_cue-low_stim-high_rampup';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(11).onset = double(cue.rampup_onset(lowcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(11).duration = double(cue.rampup_dur(lowcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(11).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(11).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(11).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(12).name = 'STIM_cue-low_stim-high_rampdown';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(12).onset = double(cue.rampdown_onset(lowcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(12).duration = double(cue.rampdown_dur(lowcue(:,1) & highstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(12).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(12).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(12).orth = 0;
% cond 5 : STIM_cue-low_stim-med
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(13).name = 'STIM_cue-low_stim-med';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(13).onset = double(cue.plateau_onset(lowcue(:,1) & medstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(13).duration = double(repelem(5, length(double(cue.plateau_onset(lowcue(:,1) & medstim(:,1)))))');
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(13).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(13).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(13).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(14).name = 'STIM_cue-low_stim-med_rampup';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(14).onset = double(cue.rampup_onset(lowcue(:,1) & medstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(14).duration = double(cue.rampup_dur(lowcue(:,1) & medstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(14).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(14).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(14).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(15).name = 'STIM_cue-low_stim-med_rampdown';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(15).onset = double(cue.rampdown_onset(lowcue(:,1) & medstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(15).duration = double(cue.rampdown_dur(lowcue(:,1) & medstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(15).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(15).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(15).orth = 0;

% cond 6 : STIM_cue-low_stim-low
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(16).name = 'STIM_cue-low_stim-low';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(16).onset = double(cue.plateau_onset(lowcue(:,1) & lowstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(16).duration = double(repelem(5, length(double(cue.plateau_onset(lowcue(:,1) & lowstim(:,1)))))');
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(16).tmod = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(17).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(17).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(18).name = 'STIM_cue-low_stim-low_rampdown';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(18).onset = double(cue.rampdown_onset(lowcue(:,1) & lowstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(18).duration = double(cue.rampdown_dur(lowcue(:,1) & lowstim(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(18).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(18).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(18).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(19).name = 'CUE_cue-high';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(19).onset = double(cue.onset01_cue(highcue(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(19).duration = double(repelem(1, length(double(cue.onset01_cue(highcue(:,1)))))');
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(19).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(19).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(19).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(20).name = 'CUE_cue-low';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(20).onset = double(cue.onset01_cue(lowcue(:,1)));
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(20).duration = double(repelem(1, length(double(cue.onset01_cue(lowcue(:,1)))))');
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(20).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(20).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(20).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(21).name = 'EXPECT_RATING';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(21).onset = double(cue.onset02_ratingexpect);
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(21).duration = double(cue.pmod_expectRT);
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(21).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(21).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(21).orth = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(22).name = 'OUTCOME_RATING';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(22).onset = double(cue.onset04_ratingoutcome);
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(22).duration = double(cue.pmod_outcomeRT);
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(22).tmod = 0;
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(22).pmod = struct('name', {}, 'param', {}, 'poly', {});
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(22).orth = 0;
