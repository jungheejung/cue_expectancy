...
#SBATCH -o /dartfs-hpc/scratch/f0042x1/spm/log_ceso/GLM_%A_%a.o
#SBATCH -e /dartfs-hpc/scratch/f0042x1/spm/log_ceso/GLM_%A_%a.e
#SBATCH --account=DBIC
...
#INPUT_DIR="${MAIN_DIR}/analysis/fmri/smooth6mm" #/dartfs-hpc/rc/lab/C/CANlab/labdata/data/spacetop_data/derivatives/fmriprep/results/fmriprep/sub-0016/ses-01/func
FMRIPREP_DIR="/dartfs-hpc/rc/lab/C/CANlab/labdata/data/spacetop_data/derivatives/fmriprep/results/fmriprep"
INPUT_DIR=${FMRIPREP_DIR}
BADRUNJSON="/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/scripts/bad_runs.json"
SAVE_DIR="/dartfs-hpc/scratch/f0042x1/spm/model02_CESO_nosmooth" #/scratch/main_dir, 'analysis', 'fmri', 'spm', 'univariate', 'model01_6cond_ttl1'
