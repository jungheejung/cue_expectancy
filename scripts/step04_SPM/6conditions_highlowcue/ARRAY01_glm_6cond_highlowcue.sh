...
addpath(genpath('"'${PWD}'"'))
s01_glm_6cond_highlowcue('"'${PARTICIPANT_LABEL}'"','"'${INPUT_DIR}'"','"'${MAIN_DIR}'"','"'${FMRIPREP_DIR}'"', '"'${BADRUNJSON}'"');'"
