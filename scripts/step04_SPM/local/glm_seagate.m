...
input_list = {'0003', '0004', '0005', '0006', '0007',...
   '0008', '0009', '0010', '0015', '0020' };

for sub =1:size(input_list,1)
input = input_list(sub);
numscans = 56;
disacqs = 0;
disp(input);
...
fmriprep_dir = '/Volumes/seagate/spacetop/derivatives/dartmouth/fmriprep/';
main_dir = '/Volumes/seagate/spacetop/social';
...
% extract nifti info ________________
niilist = dir(fullfile(fmriprep_dir, sub, '*/func/smooth_5mm*task-social*_bold.nii'));
...
% get intersection of nifti and onset
...
for run_ind = 1:size(A,1)
    disp(strcat('_________________________run', num2str(run_ind), '_________________________'));
    ...
    matlabbatch{1}.spm.stats.fmri_spec.mask = cellstr(mask_nii);
