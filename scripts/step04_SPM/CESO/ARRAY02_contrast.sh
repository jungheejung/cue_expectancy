...
INPUT_DIR="/dartfs-hpc/scratch/f0042x1/spm/model02_CESO"
...
matlab -nodisplay -nosplash -batch "addpath('${SPM_DIR}'); addpath(genpath('${CANLABCORE_DIR}')); addpath(genpath('${MAIN_DIR}/scripts/step04_SPM/CESO')); s02_contrast('${PARTICIPANT_LABEL}', '${INPUT_DIR}', '${MAIN_DIR}');"
