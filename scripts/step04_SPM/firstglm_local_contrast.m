function firstglm_local_contrast(input)
%-----------------------------------------------------------------------
...
% /Users/h/Documents/projects_local/social_influence_analysis/analysis/fmri/spm/model-01_CcEScaA/1stLevel/sub-0006/SPM.mat
...
filelist = dir('/Users/h/Downloads/*task-social_*_bold.nii');
...
for run_ind = 1: size(sortedT,1)
    ...
    onset_fname   = dir(fullfile(onset_dir, sub, ses, strcat(sub, '_', ses, '_task-social_', strcat('run-', sprintf('%02d', run_num)), '-*_events.tsv')));
    social        = struct2table(tdfread(fullfile(char(onset_fname.folder), char(onset_fname.name))));
    keyword       = extractBetween(onset_fname.name, 'run-0', '_events.tsv');
...
matlabbatch{1}.spm.stats.con.consess{1}.tcon = struct('name', 'cue_P>VC',  'weights', c01, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{2}.tcon = struct('name', 'cue_V>PC',  'weights', c02, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{3}.tcon = struct('name', 'cue_C>PV',  'weights', c03, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{4}.tcon = struct('name', 'cue_G',     'weights', c04, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{5}.tcon = struct('name', 'stim_P>VC', 'weights', c05, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{6}.tcon = struct('name', 'stim_V>PC', 'weights', c06, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{7}.tcon = struct('name', 'stim_C>PV', 'weights', c07, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{8}.tcon = struct('name', 'stim_G',    'weights', c08, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{9}.tcon = struct('name',  'stimXcue_P>VC',  'weights', c09, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{10}.tcon = struct('name', 'stimXcue_V>PC',  'weights', c10, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{11}.tcon = struct('name', 'stimXcue_C>PV',  'weights', c11, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{12}.tcon = struct('name', 'stimXcue_G',     'weights', c12, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{13}.tcon = struct('name', 'stimXactual_P>VC', 'weights', c13, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{14}.tcon = struct('name', 'stimXactual_V>PC', 'weights', c14, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{15}.tcon = struct('name', 'stimXactual_C>PV', 'weights', c15, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{16}.tcon = struct('name', 'stimXactual_G',    'weights', c16, 'sessrep' , 'none');
matlabbatch{1}.spm.stats.con.consess{17}.tcon = struct('name', 'motor', 'weights', c17, 'sessrep' , 'none');
...
batch_fname = fullfile(output_dir, strcat(strcat(sub, '_contrastbatch.mat')));
