...
#SBATCH -o /dartfs-hpc/scratch/f0042x1/spm/log_fullpain/GLM_%A_%a.o
#SBATCH -e /dartfs-hpc/scratch/f0042x1/spm/log_fullpain/GLM_%A_%a.e
#SBATCH --account=DBIC
...
SAVE_DIR="/dartfs-hpc/scratch/f0042x1/spm/model01_6cond_fullpain" #/scratch/main_dir, 'analysis', 'fmri', 'spm', 'univariate', 'model01_6cond_ttl1'
