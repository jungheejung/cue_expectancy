...
firstlevel_dir = '/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/spm/univariate/model01_6cond_highlowcue_rampplateauu';
...
for sub = 1:length(sub_list)
    ...
    try
        ...
        save_dir = firstlevel_dir, '/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/scripts/step04_SPM/model01_6cond_highlowcue_rampplateau';
