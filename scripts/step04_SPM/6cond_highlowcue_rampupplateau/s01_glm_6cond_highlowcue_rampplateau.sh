...
addpath(genpath('"'${PWD}'"'))
s01_glm_6cond_highlowcue_rampplateau('"'${PARTICIPANT_LABEL}'"','"'${INPUT_DIR}'"','"'${MAIN_DIR}'"','"'${FMRIPREP_DIR}'"', '"'${BADRUNJSON}'"');'"
