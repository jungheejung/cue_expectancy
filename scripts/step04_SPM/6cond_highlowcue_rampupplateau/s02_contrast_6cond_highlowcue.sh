...
#SBATCH -o /dartfs-hpc/scratch/f0042x1/spm/log_ramp/CON_%A_%a.o
...
SAVE_DIR="/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/spm/univariate/model01_6cond_highlowcue_rampplateau" #/scratch/main_dir, 'analysis', 'fmri', 'spm', 'univariate', 'model01_6cond_ttl1'

# Find eligibel participants based on single trial data
# check the subject folders in single trial
...
addpath(genpath('"'${PWD}'"'))
s02_contrast_6cond_highlowcue('"'${PARTICIPANT_LABEL}'"','"'${INPUT_DIR}'"','"'${MAIN_DIR}'"','"'${SAVE_DIR}'"');'"
