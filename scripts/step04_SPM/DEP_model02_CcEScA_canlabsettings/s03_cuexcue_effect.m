...
pain_t = dir(fullfile(spm_1stlevel_dir, '*/spmT_0005.nii'));    
...
vic_t = dir(fullfile(spm_1stlevel_dir,'*/spmT_0006.nii'));    
...
cog_t = dir(fullfile(spm_1stlevel_dir,'*/spmT_0007.nii'));    
...
gen_t = dir(fullfile(spm_1stlevel_dir,'*/spmT_0008.nii'));    
...
if ~exist(fullfile(save_dir,'cuexcue_contrast'), 'dir');
    mkdir(fullfile(save_dir,'cuexcue_contrast'));
end
pain_dat.fullpath = fullfile(save_dir,'cuexcue_contrast', 'cuexcue_P_T.nii');
write(pain_dat)
vic_dat.fullpath = fullfile(save_dir,'cuexcue_contrast', 'cuexcue_V_T.nii');
write(vic_dat)
cog_dat.fullpath = fullfile(save_dir,'cuexcue_contrast', 'cuexcue_C_T.nii');
write(cog_dat)
gen_dat.fullpath = fullfile(save_dir,'cuexcue_contrast', 'cuexcue_G_T.nii');
write(gen_dat)
motor_dat.fullpath = fullfile(save_dir,'cuexcue_contrast', 'motor_T.nii');
write(motor_dat)
...
drawnow, snapnow;
montage(P_fdr);
saveas(gcf, fullfile(save_dir,'cuexcue_contrast','cuexcue_fdr_01pain.png'));

P_unc = threshold(pain_dat, .005, 'unc', 'k', 10);
montage(P_unc)
drawnow, snapnow;
saveas(gcf, fullfile(save_dir,'cuexcue_contrast','cuexcue_unc_01pain.png'));
close all
%% V
create_figure('montage'); axis off
drawnow, snapnow;
montage(V_fdr);
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','cuexcue_fdr_02vicarious.png'));

V_unc = threshold(vic_dat, .005, 'unc', 'k', 10);
montage(V_unc)
drawnow, snapnow;
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','cuexcue_unc_02vicarious.png'));
close all
...
drawnow, snapnow;
montage(C_fdr);
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','cuexcue_fdr_03cognitive.png'));

C_unc = threshold(cog_dat, .005, 'unc', 'k', 10);
montage(C_unc)
drawnow, snapnow;
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','cuexcue_unc_03cognitive.png'));
close all

create_figure('montage'); axis off
drawnow, snapnow;
montage(G_fdr);
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','cuexcue_fdr_04general.png'));

G_unc = threshold(gen_dat, .005, 'unc', 'k', 10);
montage(G_unc)
drawnow, snapnow;
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','cuexcue_unc_04general.png'));
...
drawnow, snapnow;
montage(M_fdr);
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','/motor_fdr.png'));

M_unc = threshold(motor_dat, .005, 'unc', 'k', 10);
montage(M_unc)
drawnow, snapnow;
saveas(gcf,fullfile(save_dir,'cuexcue_contrast','/motor_unc.png'));
close all