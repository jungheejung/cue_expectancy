...
output_dir = fullfile(main_dir,'analysis', 'fmri', 'spm','univariate', 'model-02_CcEScA_canlabsettings',...
'1stLevel',sub);
if ~exist(output_dir, 'dir')
    mkdir(output_dir)
end
disp(strcat('SPM will be saved here:', output_dir));
...
%% regressor ______________________________________________________
    ...
    matlabbatch{1}.spm.stats.fmri_spec.cvi = 'None'; %'AR(1)', 'None', 'FAST'
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).hpf = 180;
end
