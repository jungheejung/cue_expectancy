function s01_glm(sub, input_dir, main_dir, fmriprep_dir)
    ...
    for run_ind = 1:size(A, 1)
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(3).pmod(1).name = 'expectrating';
        matlabbatch{1}.spm.stats.fmri_spec.sess(run_ind).cond(3).pmod(1).param = double(cue.pmod_expectangle_demean);
