...
for run_ind = 1: runlength
    ...
    C_PV_cue_high_gt_low         = [ (m3(task)*cue_high_gt_low)/runlength,0,0,0,covariate ];

    P_VC_stimlin_high_gt_low     = [ (m1(task)*stimlin_high_gt_low)/runlength,0,0,0,covariate ];
    V_PC_stimlin_high_gt_low     = [ (m2(task)*stimlin_high_gt_low)/runlength,0,0,0,covariate ];
    C_PV_stimlin_high_gt_low     = [ (m3(task)*stimlin_high_gt_low)/runlength,0,0,0,covariate ];

    P_VC_stimquad_med_gt_other   = [ (m1(task)*stimquad_med_gt_other)/runlength,0,0,0,covariate ];
    V_PC_stimquad_med_gt_other   = [ (m2(task)*stimquad_med_gt_other)/runlength,0,0,0,covariate ];
    C_PV_stimquad_med_gt_other   = [ (m3(task)*stimquad_med_gt_other)/runlength,0,0,0,covariate ];

    P_VC_cue_int_stimlin         = [ (m1(task)*cue_int_stimlin)/runlength,0,0,0,covariate ];
    V_PC_cue_int_stimlin         = [ (m2(task)*cue_int_stimlin)/runlength,0,0,0,covariate ];
    C_PV_cue_int_stimlin         = [ (m3(task)*cue_int_stimlin)/runlength,0,0,0,covariate ];

    P_VC_cue_int_stimquad        = [ (m1(task)*cue_int_stimquad)/runlength,0,0,0,covariate ];
    V_PC_cue_int_stimquad        = [ (m2(task)*cue_int_stimquad)/runlength,0,0,0,covariate ];
    C_PV_cue_int_stimquad        = [ (m3(task)*cue_int_stimquad)/runlength,0,0,0,covariate ];

    motor                        = [ 0,0,0,0,0,0,0,1,1,covariate ];

    P_simple_cue_high_gt_low         = [ (m5(task)*cue_high_gt_low)/runlength,0,0,0,covariate ];
    V_simple_cue_high_gt_low         = [ (m6(task)*cue_high_gt_low)/runlength,0,0,0,covariate ];
    C_simple_cue_high_gt_low         = [ (m7(task)*cue_high_gt_low)/runlength,0,0,0,covariate ];

    P_simple_stimlin_high_gt_low     = [ (m5(task)*stimlin_high_gt_low)/runlength,0,0,0,covariate ];
    V_simple_stimlin_high_gt_low     = [ (m6(task)*stimlin_high_gt_low)/runlength,0,0,0,covariate ];
    C_simple_stimlin_high_gt_low     = [ (m7(task)*stimlin_high_gt_low)/runlength,0,0,0,covariate ];

    P_simple_stimquad_med_gt_other   = [ (m5(task)*stimquad_med_gt_other)/runlength,0,0,0,covariate ];
    V_simple_stimquad_med_gt_other   = [ (m6(task)*stimquad_med_gt_other)/runlength,0,0,0,covariate ];
    C_simple_stimquad_med_gt_other   = [ (m7(task)*stimquad_med_gt_other)/runlength,0,0,0,covariate ];

    P_simple_cue_int_stimlin         = [ (m5(task)*cue_int_stimlin)/runlength,0,0,0,covariate ];
    V_simple_cue_int_stimlin         = [ (m6(task)*cue_int_stimlin)/runlength,0,0,0,covariate ];
    C_simple_cue_int_stimlin         = [ (m7(task)*cue_int_stimlin)/runlength,0,0,0,covariate ];

    P_simple_cue_int_stimquad        = [ (m5(task)*cue_int_stimquad)/runlength,0,0,0,covariate ];
    V_simple_cue_int_stimquad        = [ (m6(task)*cue_int_stimquad)/runlength,0,0,0,covariate ];
    C_simple_cue_int_stimquad        = [ (m7(task)*cue_int_stimquad)/runlength,0,0,0,covariate ];

    P_simple_highcue_highstim        = [ (m5(task)*highcue_highstim)/runlength,0,0,0,covariate ]; 
    P_simple_highcue_medstim         = [ (m5(task)*highcue_medstim)/runlength,0,0,0,covariate ]; 
    P_simple_highcue_lowstim         = [ (m5(task)*highcue_lowstim)/runlength,0,0,0,covariate ]; 
    P_simple_lowcue_highstim         = [ (m5(task)*lowcue_highstim)/runlength,0,0,0,covariate ]; 
    P_simple_lowcue_medstim          = [ (m5(task)*lowcue_medstim)/runlength,0,0,0,covariate ]; 
    P_simple_lowcue_lowstim          = [ (m5(task)*lowcue_lowstim)/runlength,0,0,0,covariate ]; 

    V_simple_highcue_highstim        = [ (m6(task)*highcue_highstim)/runlength,0,0,0,covariate ]; 
    V_simple_highcue_medstim         = [ (m6(task)*highcue_medstim)/runlength,0,0,0,covariate ]; 
    V_simple_highcue_lowstim         = [ (m6(task)*highcue_lowstim)/runlength,0,0,0,covariate ]; 
    V_simple_lowcue_highstim         = [ (m6(task)*lowcue_highstim)/runlength,0,0,0,covariate ]; 
    V_simple_lowcue_medstim          = [ (m6(task)*lowcue_medstim)/runlength,0,0,0,covariate ]; 
    V_simple_lowcue_lowstim          = [ (m6(task)*lowcue_lowstim)/runlength,0,0,0,covariate ]; 

    C_simple_highcue_highstim        = [ (m7(task)*highcue_highstim)/runlength,0,0,0,covariate ]; 
    C_simple_highcue_medstim         = [ (m7(task)*highcue_medstim)/runlength,0,0,0,covariate ]; 
    C_simple_highcue_lowstim         = [ (m7(task)*highcue_lowstim)/runlength,0,0,0,covariate ]; 
    C_simple_lowcue_highstim         = [ (m7(task)*lowcue_highstim)/runlength,0,0,0,covariate ]; 
    C_simple_lowcue_medstim          = [ (m7(task)*lowcue_medstim)/runlength,0,0,0,covariate ]; 
    C_simple_lowcue_lowstim          = [ (m7(task)*lowcue_lowstim)/runlength,0,0,0,covariate ]; 
