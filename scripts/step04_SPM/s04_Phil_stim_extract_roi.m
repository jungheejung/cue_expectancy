...
drawnow, snapnow
%% 1. simple PAIN ==============================================================
simpleP_t = dir(fullfile(mount_dir, '/*/con_0005.nii'));    
simpleP_t(15,:) = [];
...
xlabel('Region')
ylabel('ROI activity')
saveas(gcf,'../../figures/buckner_Pain_con_STIM.png');

%% vicarious ==============================================================
simpleV_t = dir(fullfile(mount_dir, '/*/con_0006.nii'));   
simpleV_t(15,:) = [];
...
saveas(gcf,'../../figures/buckner_Vicarious_con_STIM.png');


%% cognitive ==============================================================
simpleC_t = dir(fullfile(mount_dir, '/*/con_0007.nii'));   
simpleC_t(15,:) = [];
...
saveas(gcf,'../../figures/buckner_Cognitive_con_STIM.png');
sub_save_dir = '/Users/h/Documents/projects_local/social_influence_analysis/analysis/fmri/roi_extraction';
saveFileName = fullfile(sub_save_dir,'atlas-buckner_task-pain_con_STIM.csv' );
writetable(PT,saveFileName);

% sub_save_dir = '/Users/h/Documents/projects_local/social_influence_analysis/analysis/fmri';
saveFileName = fullfile(sub_save_dir,'atlas-buckner_task-vicarious_con_STIM.csv' );
writetable(VT,saveFileName);

% sub_save_dir = '/Users/h/Documents/projects_local/social_influence_analysis/analysis/fmri';
saveFileName = fullfile(sub_save_dir,'atlas-buckner_task-cognitive_con_STIM.csv' );
