...
save('mediation_XcueYoutcomeMcov.mat', 'X', 'Y', 'Minterim', 'cov', 'sub');

%----------------------------
%% drop missing rows (ver 1.)
% ----------------------------
load('mediation_XcueYoutcomeMcov.mat');
...
mediation_brain_multilevel(X_filtered, zscored_Y_filtered, M_filtered_char, SETUP, 'nopreproc', 'covs', cov_filtered,  'boot', 'bootsamples', 1000);
