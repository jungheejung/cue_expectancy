...
for e = 1:length(eventlist)
    ...
    %     metadf_clean = remove_missing_behvalues(merge_beh_nii, 'outcomerating');
        ...
        cov{1,s} = [mediation_df.stim_contrast mediation_df.NPS];
...
save('mediation_XcueYoutcomeMbrain_covstimNPS_L2NPS.mat', 'X', 'Y', 'Minterim', 'cov', 'l2m', 'sub');
...
% ----------------------------
load('mediation_XcueYoutcomeMbrain_covstimNPS_L2NPS.mat');
missingIndices = [];    % Initialize an empty array to store missing indices
