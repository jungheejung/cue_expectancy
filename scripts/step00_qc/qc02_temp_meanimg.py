...
fmriprep_fmriprepmask.to_csv(os.path.join(htmlsave_dir,f'task-{task}_nifti-fmriprep_mask-fmriprep.csv'))
beta_nomask.to_csv(os.path.join(htmlsave_dir,f'task-{task}_nifti-beta_mask-nomask.csv'))
beta_canlab.to_csv(os.path.join(htmlsave_dir,f'task-{task}_nifti-beta_mask-canlab.csv'))
# %%
