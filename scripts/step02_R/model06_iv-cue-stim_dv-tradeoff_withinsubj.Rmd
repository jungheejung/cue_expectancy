---
title: "model06_iv-cue-stim_dv-tradeoff_withinsubject"
author: "Heejung Jung"
date: '2022-07-17'
output:
  html_document:
...
analysis_dir <- file.path(main_dir, "analysis", "mixedeffect", "model05_iv-cue-stim_dv-tradeoff", as.character(Sys.Date()))
...
### Method 1-1 effectsize estimate (one-sample t-test)
...
### Method 1-2 effectsize estimate (one-sample t-test)
...
xfun::file_string('/Users/h/Dropbox/projects_dropbox/social_influence_analysis/scripts/step02_R/matlab_model05_iv_cue_stim_dv_tradeoff_withinsubject.html')
```
````
