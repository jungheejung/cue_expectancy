---
title: "socialinfluence_dartmouth_N=60"
author: "Heejung Jung"
date: "8/21/2021"
...
### FUNCTION: run_cue_stim_ses_lmer
```{r}
...
analysis_dir =file.path(main_dir,'analysis', 'mixedeffect', 'model01_cue_expectrating_N60')
...
```{r}
FILENAME = paste('*_task-social_*-' ,TASKNAME, '_beh.csv', sep = "")
common_path = Sys.glob(file.path(main_dir,'data', 'dartmouth', 'd02_preprocessed_N60', 'sub-*','ses-*',FILENAME))
filter_path = common_path[!str_detect(common_path,pattern="sub-0001|sub-0025")]
...
DATA = expect_df(TASKNAME, SUBJECT_VARKEY, IV, DV, EXCLUDE )
analysis_dir = file.path(main_dir,'analysis', 'mixedeffect', 'model02_cue_stim_actualrating_N60')
...
plot_filename = file.path(main_dir, 'analysis','mixedeffect','model02_cue_stim_actualrating_N60', paste('socialinfluence_task-total_rating-',DV_KEYWORD,'.png', sep = ""))
...
plot_filename = file.path(main_dir, 'analysis','mixedeffect','model02_cue_stim_actualrating_N60', paste('socialinfluence_task-total_rating-',DV_KEYWORD,'_correlation-rand-cue-coef.png', sep = ""))
ggsave(plot_filename, width = 7, height = 3)
...
ggpubr::ggarrange(PV,VC,CP,ncol = 3, nrow = 1, common.legend = FALSE,legend = "bottom")
plot_filename = file.path(main_dir, 'analysis','mixedeffect','model02_cue_stim_actualrating_N60', paste('socialinfluence_task-total_rating-',DV_KEYWORD,'_correlation-rand-cue-coef_rmoutlier.png', sep = ""))
ggsave(plot_filename, width = 7, height = 3)
...
plot_filename = file.path(main_dir, 'analysis','mixedeffect','model02_cue_stim_actualrating_N60', paste('socialinfluence_task-total_rating-',DV_KEYWORD,'_per_session.png', sep = ""))
...
# cue effect per session 
session_groupwise = summarySEwithin(data=combined_se_calc_cue, measurevar = "mean_per_sub_mean", withinvars = c("stim_ordered","session_id"), idvar = "subject")
...
ggpubr::ggarrange(p11,p12,p13,p21,p22,p23,p31,p32,p33,ncol = 3, nrow = 3, common.legend = TRUE,legend = "bottom")
plot_filename = file.path(main_dir, 'analysis','mixedeffect','model02_cue_stim_actualrating_N60', paste('socialinfluence_task-total_rating-',DV_KEYWORD,'_per_session_cueeffect.png', sep = ""))
ggsave(plot_filename, width = 7, height = 9)
