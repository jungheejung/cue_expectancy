...
data_clean$subject = factor(data_clean$src_subject_id)
    # model_onefactor <- lmer(event03_RT ~param_cue_type + (param_cue_type|subject), data = data )
#     # cooksd <- cooks.distance(model_onefactor)
# cooksd <- lmer_onefactor_cooksd_fix(
#         data_clean, taskname, iv, dv, subject, dv_keyword, model_savefname
#     )
