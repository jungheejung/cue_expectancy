...
ggsave('/Users/h/Documents/projects_local/social_influence_analysis/analysis/mixedeffect/boulder/task-cognitive_rating-expect.png', width = w, height = h)
```
...
```{r}
# PSEUDOCODE: radians ~ cue + administerlevel + cue*administerlevel + (cue*administerlevel | subject)
model.cog_actual = lmer(actual_degree ~ social_cue*level_con_linear + social_cue *level_con_quad+ (social_cue*level_con_linear + social_cue *level_con_quad| subject), data= cog_actual_removeNA)
...
h = 3
g
ggsave('/Users/h/Documents/projects_local/social_influence_analysis/analysis/mixedeffect/boulder/task-cognitive_rating-actual.png', width = w, height = h)
```
