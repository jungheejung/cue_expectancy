...
main_dir = fileparts(fileparts(fileparts(fileparts(pwd))));
...
sublist = [6,7,8,9,10,11,13,14,28,29,30,31,32,33,35,37,43,47,53,55,58,60,61,62,64,65,66,68,69,70,73,76,78,79,80,84,85]; 
...
for s = 1:length(sublist)
    ...
    X{1, s} = T.stim_lin; % table2array(T(:, 'cue_con'));% T.cue; %
