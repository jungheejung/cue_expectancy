...
for sub in sub_list:
    ...
    if beh_list:
        for ind, fpath in enumerate(sorted(beh_list)):
            ...
            sub_num = int(
                re.findall(
                    "\d+", [match for match in fname.split("_") if "sub" in match][0]
                )[0]
            )
            ses_num = int(
                re.findall(
            ...
            new.loc[cue_num : cue_num + trial_num - 1, "onset"] = list(
                df["event03_stim_latephase_4500-9000ms"]
            )
            ...
            new.loc[
                cue_num + trial_num + 1 : cue_num + trial_num + nuissance_num + 1,
                "nifti_name",
            ] = list(nuissance)
            new["sub"] = sub_num
            new.loc[
                cue_num + trial_num + 1 : cue_num + trial_num + nuissance_num + 1, "ses"
            ] = ses_num
            new.loc[
                cue_num + trial_num + 1 : cue_num + trial_num + nuissance_num + 1, "run"
            ] = run_num
            new.loc[
                cue_num + trial_num + 1 : cue_num + trial_num + nuissance_num + 1,
                "task",
