...
%sublist = [3,4,5,6,7,8,9,10,14,15,16,19,20,21,23,24,25,26,28,29,30,32,33,35,37,43,47,51,53,55,58,60];
...
for s = 1:length(sublist)
    ...
    fname = strcat('metadata_', sub ,'_task-cognitive_ev-stim.csv');
