...
ev_single_dir = os.path.join(main_dir, 'data', 'dartmouth', 'd06_singletrial_SPM_04-pain-plateau')
...
for sub in sub_list:
    ...
    if beh_list:
        ...
        subject_dataframe.to_csv(os.path.join(ev_single_dir, sub,  f'{sub}_singletrial_plateau.csv'), index_col=False)
    else:
