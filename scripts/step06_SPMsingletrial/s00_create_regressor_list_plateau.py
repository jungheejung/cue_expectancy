...
ev_single_dir = os.path.join(main_dir, 'data', 'dartmouth', f'd06_singletrial_SPM_01-pain-{keyword}')
...
for sub in sub_list:
    ...
    if beh_list:
        ...
        subject_dataframe.to_csv(os.path.join(ev_single_dir, sub,  f'{sub}_singletrial_{keyword}.csv'), index=False)
    else:
