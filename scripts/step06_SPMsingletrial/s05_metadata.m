...
nifti_dir = fullfile(main_dir, 'analysis','fmri','spm','multivariate','s03_concatnifti');i
sublist = [3,4,5,6,7,8,9,10,14,15,16,18,19,20,21,23,24,25,26,28,29,30,31,32,33,35,37,43,47,51,53,55,58,60]
%sublist = [2,3,4,5,6,7,8,9,10,14,15,16,18,19,20,21,23,24,25,26,28,29,30,31,32,33,35];
eventlist = {'cue', 'stim'}
