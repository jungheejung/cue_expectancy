...
save_fname = fullfile(task_subfldr, strcat('task-',task, '_PDM-mincomp_stimlin-stim-actual.mat'));
...
save_fname = fullfile(task_subfldr, strcat('task-',task, '_PDM-plot_stimlin-stim-actual.mat'));
save(save_fname,'pdm');
...
save_fname = fullfile(task_subfldr, strcat('task-',task, '_PDM-bootstrap_stimlin-stim-actual.mat'));
