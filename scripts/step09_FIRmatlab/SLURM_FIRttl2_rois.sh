#!/bin/bash -l
#SBATCH --job-name=par2
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=8G
#SBATCH --time=06:30:00
#SBATCH -o ./log_rois2/fir_ttl2_%A_%a.o
#SBATCH -e ./log_rois2/fir_ttl2_%A_%a.e
#SBATCH --account=DBIC
#SBATCH --partition=standard
#SBATCH --array=4-133%50
...
SAVE_DIR='/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/spm/fir/ttl2par'
