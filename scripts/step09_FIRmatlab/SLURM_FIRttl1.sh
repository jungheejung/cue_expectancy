#!/bin/bash -l
#SBATCH --job-name=stim_ttl1
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=12
#SBATCH --mem-per-cpu=16G
#SBATCH --time=24:00:00
#SBATCH -o ./log_ttl1/ttl1_%A_%a.o
#SBATCH -e ./log_ttl1/ttl1_%A_%a.e
#SBATCH --account=DBIC
#SBATCH --partition=standard
#SBATCH --array=80-133%50
...
SAVE_DIR="/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/spm/fir/ttl1"
...
addpath(genpath('"'${PWD}'"'))
FIR_spm_ttl1('"'${PARTICIPANT_LABEL}'"','"'${INPUT_DIR}'"','"'${MAIN_DIR}'"','"'${FMRIPREP_DIR}'"', '"'${BADRUNJSON}'"');'"
