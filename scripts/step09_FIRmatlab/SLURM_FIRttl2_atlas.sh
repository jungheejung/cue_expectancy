...
#SBATCH -o ./log_ttl2/ttl2_%A_%a.o
#SBATCH -e ./log_ttl2/ttl2_%A_%a.e
#SBATCH --account=DBIC
...
SAVE_DIR="/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/spm/fir/ttl2_atlas"
