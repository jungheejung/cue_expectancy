...
with open(join(main_dir,'analysis/fmri/nilearn/deriv02_parcel-glasser', 
               'singletrial_rampupplateau_task-pvc_epoch-stimulus_atlas-glasser.json'), 'w') as json_file:
    json.dump(data, json_file, indent=4)
with open(join(save_discovery_dir,'singletrial_rampupplateau_task-pvc_epoch-stimulus_atlas-glasser.json'), 'w') as json_file:
    json.dump(data, json_file, indent=4)
with open(join('/Volumes/seagate/cue_singletrials/singletrial_rampupplateau_task-pvc_epoch-stimulus_atlas-glasser.json'), 'w') as json_file:
    json.dump(data, json_file, indent=4)
...
df_final.to_csv(join(save_discovery_dir, 'singletrial_rampupplateau_task-pvc_epoch-stimulus_atlas-glasser.tsv'), 
                sep='\t', index=False, header=True)
df_final.to_csv(join(main_dir, 'analysis/fmri/nilearn/deriv02_parcel-glasser', 
                     'singletrial_rampupplateau_task-pvc_epoch-stimulus_atlas-glasser.tsv'), 
                sep='\t', index=False, header=True)
df_final.to_csv(join('/Volumes/seagate/cue_singletrials/singletrial_rampupplateau_task-pvc_epoch-stimulus_atlas-glasser.tsv'), 
                sep='\t', index=False, header=True)
