...
np.save(join(main_dir, 'analysis/fmri/nilearn/deriv02_parcel-glasser/singletrial_rampupplateau_task-pvc_epoch-cue_atlas-glasser.npy.npy'),parcel_value)
np.save(join('/Volumes/seagate/cue_singletrials/singletrial_rampupplateau_task-pvc_epoch-cue_atlas-glasser.npy.npy'),parcel_value)
