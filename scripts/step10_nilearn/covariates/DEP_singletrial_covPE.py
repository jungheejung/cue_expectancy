...
slurm_id = 44
task = 'pain'
fmri_event = 'stimulus' #args.fmri_event
beh_regressor = 'PE'#args.beh_regressor # event02_expect_angle
beh_savename = 'PE' #args.beh_savename #expectrating
save_dir = '/Users/h/Desktop/TMP' #args.savedir
# %% -------------------------------------------------------------------
#                               parameters 
# ----------------------------------------------------------------------
...
beta_dir = join(main_dir, 'analysis', 'fmri', 'nilearn', 'deriv04_covariate')
...
# within beta_dir, identify how many existing subjects
