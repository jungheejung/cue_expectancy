...
###########################################################################################################################
# save data 
with h5py.File('task-pain_event-stimulus.h5', 'w') as f:
    f.create_dataset('data', data=X_painstim)
paindf_meta.to_csv('task-pain_event-stimulus.csv')
# Load the saved array
with h5py.File('task-pain_event-stimulus.h5', 'r') as f:
    X_painstim = f['data'][:]

# save data 
with h5py.File('task-cognitive_event-stimulus.h5', 'w') as f:
    f.create_dataset('data', data=X_cognitive)
cogdf_meta.to_csv('task-cognitive_event-stimulus.csv')
# Load the saved array
with h5py.File('task-cognitive_event-stimulus.h5', 'r') as f:
    X_cognitive = f['data'][:]
    ###########################################################################################################################
