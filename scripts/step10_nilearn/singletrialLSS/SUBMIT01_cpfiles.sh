# #!/bin/bash
cp -r /dartfs-hpc/scratch/f0042x1/singletrial_rampupdown /dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/nilearn/     
# # Define the source and destination directories
# source_dir="/dartfs-hpc/scratch/f0042x1/singletrial_rampupdown"
# dest_dir="/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/nilearn/singletrial_rampupdown"
