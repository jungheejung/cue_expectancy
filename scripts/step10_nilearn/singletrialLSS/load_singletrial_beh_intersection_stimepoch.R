...
library(dplyr)
library(purrr)
# sub-0002_ses-03_run-01_runtype-vicarious_event-stimulus_trial-000_cuetype-low_stimintensity-low
...
write.table(final_df, 
            file = file.path(events_dir, "sub-all_task-all_epoch-stim_events.tsv"), 
...
myjson <- list(dataframe_description = "This is a metadata file of behavioral data, 
  ...
  `/dartfs-hpc/rc/lab/C/CANlab/labdata/projects/spacetop_projects_cue/analysis/fmri/nilearn/singletrial_rampupplateau`",
               cue = "scripts/step10_nilearn/singletrialLSS/load_singletrial_beh_intersection_stimepoch.R",
...
write_json(myjson, file.path(events_dir, "sub-all_task-all_epoch-stim_events.json"))