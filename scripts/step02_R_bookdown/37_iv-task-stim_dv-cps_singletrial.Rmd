...
## Q. Within cognitive task, does stimulus intenisty level and cue level significantly predict Kragel Cognitive Control dotproducts?

### 2 Cue x 3 Stimulus intensity {.unlisted .unnumbered}
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
### Cohen's d: Cognitive control stimulus intensity = 0.72 {.unlisted .unnumbered}
```{r echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
...
kableExtra::kable_styling(
  knitr::kable(
    lme.dscore(model.cogstim, pvc, type = "lme4"), # MODIFY
    "html"), "striped", position = "left", font_size = 15)
```
...
### Cohen's d: Cognitive Control stimulus intensity d = 0.73, cue level d = 0.069 {.unlisted .unnumbered}
...
## Q. Is the cue effect on Cognitive signature different across sessions?
...
### Session 1: 2 Cue x 3 Stimulus intensity {.unlisted .unnumbered}
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
combined_se_calc_cooksd <- data.frame()
taskname = "cognitive"
    ggtitle <- paste(taskname, " - actual judgment (degree)")
...
### Session 3: 2 Cue x 3 Stimulus intensity {.unlisted .unnumbered}
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
combined_se_calc_cooksd <- data.frame()
taskname = "cognitive"
    ggtitle <- paste(taskname, " - actual judgment (degree)")
...
### Session 4: 2 Cue x 3 Stimulus intensity {.unlisted .unnumbered}
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
combined_se_calc_cooksd <- data.frame()
taskname = "cognitive"
    ggtitle <- paste(taskname, " - actual judgment (degree)")
...
## Cognitive only: Expectation ratings & Kragel 2018

## Q. What is the relationship betweeen expectation ratings & Cog-control signature? (Cognitivee task only)
