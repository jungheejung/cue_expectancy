...
g <- plot_lineplot_twofactor_subset(subsetNPS, taskname = "pain", 
                        ...
                        color = c("#5D5C5C", "#D73027"), ggtitle = "Within pain task: NPS dotproducts as a function of stimulus intensity level and cue", 
...
#### ACCURATE: NPS ~ EXPECT_demean * CUE * STIM + CMC as a function of session
...
#### ACCURATE: NPS ~ EXPECT_demean * CUE * STIM * SES + CMC as a function of session
```{r echo=TRUE, message=TRUE, warning=TRUE, paged.print=FALSE}
