...
ggplot(demean_dropna, aes(x = NPSpos,
                       y = OUTCOME_demean,
                       col=cuetype,
...
```{r echo=FALSE}
ggplot(demean_dropna[demean_dropna$stimintensity == "low", ], aes(x = NPS_demean,
                       y = OUTCOME_demean,
                       col = cuetype,
                       shape = sub), size = .3, col = c('red', 'gray')) +
  geom_point(size = .1) +
...
#### NPSpos ~ EXPECT_demean _ STIM _ CUE
