...
## 1. NPScorr \~ paintask: 2 cue x 3 stimulus_intensity
...
## 1. lmer :: Linear model results (NPScorr \~ paintask: 2 cue x 3 stimulus_intensity)
...
## 2. NPScorr (remove 1st trial) \~ CUE \* STIM
...
sjPlot::tab_model(model.npsses,
                  title = "Multilevel-modeling: \nlmer(NPScorr ~ CUE * STIM * SES + (STIM + SES | sub), data = pvc)",
                  CSS = list(css.table = '+font-size: 12;'))
```
