...
nps <- read.csv(file.path(main_dir, "analysis/fmri/nilearn/deriv01_signature/rampup_plateau/signature-NPS_sub-all_runtype-pain_event-stimulus.tsv"), sep = ",")
...
g <- plot_lineplot_twofactor(SIIPSstimcue_groupwise,# taskname = "pain",
                        ...
                        mean = "mean_per_sub_norm_mean", error = "se",
                        color = c("low cue" = "#3E61EC","high cue" = "#FF0000"), 
                        ggtitle = paste0("NPS N =", length(unique(SIIPSstimcue_subjectwise$sub)), "taskname: ", taskname),
