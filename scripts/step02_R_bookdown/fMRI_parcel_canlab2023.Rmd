...
# beta <- read.table(file = file.path(main_dir, paste0("analysis/fmri/nilearn/deriv02_parcel-canlab2023/singletrial_rampupdown", "extractdata_*_atlas-canlab2023.tsv")), sep = '\t', header = TRUE)
...
# Assuming all_data is your data frame and all_data$filename contains the filenames
library(tidyr)
library(dplyr)
