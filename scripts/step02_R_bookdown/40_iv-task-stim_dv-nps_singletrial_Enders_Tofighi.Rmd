...
g <- plot_lineplot_twofactor_subsetthick(subsetNPS, taskname = "pain",
...
g <- plot_lineplot_twofactor_subsetthick(NPSstimcue_groupwise, taskname = "pain",
                        iv1 = "stim_ordered", iv2 = "cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
                        color = c("low cue" = "#3E58E8","high cue" = "#D73027"), ggtitle = "Within pain task: NPS dotproducts as a function of stimulus intensity level and cue",
                        xlab = "Stimulus intensity", ylab = "NPSpos (dot product)")
g + theme(aspect.ratio=.8)
```
