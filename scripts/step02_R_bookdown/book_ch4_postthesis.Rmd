...
p <- cueR::plot_lineplot_twofactor_subset(SCR_groupwise, taskname = "pain",
                        iv1 = "stim_ordered", iv2 = "cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
                        color = c("low cue" = lowcuehex,"high cue" = highcuehex),
                        ggtitle = paste0("SCR N =", length(unique(NPSstimcue_subjectwise$sub))),
...
sink(file.path(savedir, "lmer_SIIPS_output.txt"))  # Redirects output to 'my_output.txt'
summary(model.SIIPS)
...
g <- cueR::plot_lineplot_twofactor_subset(SIIPS_groupwise, task = "pain",
                        iv1 = "stim_ordered", iv2 = "cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
