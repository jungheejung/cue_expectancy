...
## behavioral :: line plots cue _ stim _ intensity (demean outcome)
...
ggsave(file.path(main_dir, 'analysis/mixedeffect/CCNfigures/figB.png'), plot = fig.bsave)
fig.bsave
```
...
save.sp <- a2 +
  ...
  theme(
    # axis.line = element_line(colour = "black"),
      ...
      plot.subtitle = ggtext::element_textbox_simple(size= 11))
save.sp
ggsave(file.path(main_dir, 'analysis/mixedeffect/CCNfigures/figA2.png'), save.sp)
...
a1.save <- a1 + theme(text = element_text(size = 20)) +theme(aspect.ratio=1) +
  theme(
    # axis.line = element_line(colour = "black"),
      ...
      plot.subtitle = ggtext::element_textbox_simple(size= 11))
a1.save
ggsave(file.path(main_dir, 'analysis/mixedeffect/CCNfigures/figA1.png'), p1)
...
plots
ggsave(file.path(main_dir, 'analysis/mixedeffect/CCNfigures/figC.png'), plots)
```
