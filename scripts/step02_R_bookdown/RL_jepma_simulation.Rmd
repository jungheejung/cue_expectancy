# RL :: Jempa learning rate ~ singletrial {#RL_jepma_alpha}
...
Calculate the learning rate using the behavioral PEs
...
```{r}
    ...
    analysis_dir <- file.path(main_dir, "analysis", "mixedeffect", "jepmasimulation")
