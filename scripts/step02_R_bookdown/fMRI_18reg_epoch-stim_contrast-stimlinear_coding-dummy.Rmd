# fMRI :: high > low stim (stim epoch dummy coding) {#18reg_stim_stim_dummy}
...
htmltools::includeHTML(file.path(main_dir, "scripts", "step04_SPM", "6conditions_highlowcue_rampplateau", "s05_6condramp_stimlinear_dummy.html"))
```