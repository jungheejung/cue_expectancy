...
```{r plot_RT_distribution, echo=TRUE}
...
```{r model_1-1_correct_trials_only_7}
# parameters ___________________________________________________________________
subject_varkey <- "src_subject_id"
iv <- "param_cue_type"
dv <- "event03_RT"
...
```{r model_1-2_incorrect_trials_only_7}
# parameters ___________________________________________________________________
subject_varkey <- "src_subject_id"
iv <- "param_cue_type"
dv <- "event03_RT"
