# fMRI :: high > low cue (stim epoch dummy coding) {#18reg_stim_cue_dummy}
...
knitr::include_html(file.path(main_dir, "scripts", "step04_SPM", "6conditions_highlowcue_rampplateau", "FILLIN.html"))
```