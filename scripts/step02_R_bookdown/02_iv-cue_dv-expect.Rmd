...
```{r pain_iv-cue_dv-expect, echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
taskname = 'pain'
...
```{r vicarious_iv-cue_dv-expect, echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
taskname = 'vicarious'
ggplot_onefactor_pertask(taskname, subject_varkey, subject, exclude,
                                     analysis_dir, iv, dv, dv_keyword, 
                                     subjectwise_mean, group_mean, se,
...
```{r cognitive_iv-cue_dv-expect, echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
taskname = 'cognitive'
ggplot_onefactor_pertask(taskname, subject_varkey, subject, exclude,
                                     analysis_dir, iv, dv, dv_keyword, 
                                     subjectwise_mean, group_mean, se,
...
```{r random effects scatter plot, echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
