...
df_filter$cue_name[df_filter$cuetype == "high"] <-
  "high cue"
df_filter$cue_name[df_filter$cuetype == "low"] <-
  "low cue"
...
# 
df_filter$stim_ordered <- factor(df_filter$stimintensity,
...
plot_lineplot_onefactor <- function(data, taskname, iv, mean, error,
  ...
  subset <- data[data$runtype == taskname, ]
