...
exclude <- "sub-0001|sub-0002|sub-0003|sub-0004|sub-0005|sub-0007|sub-0008|sub-0013|sub-0016|sub-0017|sub-0019|sub-0020|sub-0021|sub-0025|sub-0075|sub-0074|sub-0085|sub-0118|sub-0117|sub-0103|sub-0063"
...
```{r echo=FALSE}
p.demean <- df_merge[df_merge$task == 'pain' & df_merge$ses == 'ses-01' |  df_merge$ses == "ses-03", ] %>%
group_by(sub) %>%
...
p.demean <-
  df_merge[df_merge$task == 'pain' &
             df_merge$ses == 'ses-01' |  df_merge$ses == "ses-03",] %>%
  group_by(sub) %>%
  mutate(event04_actual_angle = as.numeric(event04_actual_angle)) %>%
  mutate(event02_expect_angle = as.numeric(event02_expect_angle)) %>%
  mutate(avg_outcome = mean(event04_actual_angle, na.rm = TRUE)) %>%
