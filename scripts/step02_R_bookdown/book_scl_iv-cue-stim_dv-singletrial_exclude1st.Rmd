...
k <- cueR::plot_lineplot_twofactor_subset(SCLstim_groupwise,
                             taskname="pain",
                        iv1="stim_ordered",
                        iv2="cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
                        color = c( "high" = "#C5263A",
                                  "low" = "#4274AD"),
                        ggtitle = paste0("SCR N = ", length(unique(SCLstim_subjectwise$sub))),
                        xlab = "Stimulus intensity", ylab = "SCR")
...
ggsave(file.path('/Users/h/Dropbox (Personal)/2025_Jung_SpaceTop_PVC_pain_CueFx_Signatures_ROIs/Figure', paste0("fig1_SCR_maineffect", as.character(Sys.Date()), ".svg")), width = 8, height = 4, dpi=300)
