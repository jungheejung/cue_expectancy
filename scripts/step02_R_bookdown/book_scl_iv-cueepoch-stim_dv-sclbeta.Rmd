...
# /Volumes/spacetop_projects_cue/analysis/physio/nobaseline/glm_cueepoch/glm-factorialcue_task-pain_scr.tsv
beta <- read.table(file = file.path(main_dir, paste0("analysis/physio/nobaseline/glm_cueepoch/glm-factorialcue_task-", taskname, "_scr.tsv")), sep = '\t', header = TRUE)
beta <- read.table("/Volumes/spacetop_projects_cue/analysis/physio/nobaseline/glm_cueepoch/glm-factorialcue_task-pain_scr.tsv", sep = '\t', header = TRUE)
```
