...
sjPlot::tab_model(model.SIIPSses,
                  ...
                  CSS = list(css.table = '+font-size: 12;'))
```
> Using nmkbw optimizer, random slopes of cue, stimulus intensity, and sessions are modeled using orthogonal contrast codes. Cue effects on SIIPS are significant (b = -0.28, SE = 0.13, t(95.65) = -2.09, CI = [-0.54, -0.02], p = 0.037), where higher cues lead to lower SIIPS values. Stimulus intensity effects are significant; higher temperature leads to greater SIIPS response (b =  1.33, SE = 0.15, t(279.51) = 8.63, p < .001)
