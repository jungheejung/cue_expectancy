...
[ INSERT DESCRIPTION ]
```{r pain_iv-cue_dv-outcome, echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
taskname = 'pain'
...
### For the vicarious task, what is the effect of cue on outcome ratings? {.unlisted .unnumbered}
[ INSERT DESCRIPTION ]
```{r vicarious_iv-cue_dv-outcome, echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
taskname = 'vicarious'
ggplot_onefactor_pertask(taskname, subject_varkey, subject, exclude,
                                     analysis_dir, iv, iv_keyword, dv, dv_keyword, 
                                     subjectwise_mean, group_mean, se,
...
[ INSERT DESCRIPTION ]
```{r cognitive_iv-cue_dv-outcome, echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
taskname = 'cognitive'
ggplot_onefactor_pertask(taskname, subject_varkey, subject, exclude,
                                     analysis_dir, iv, iv_keyword, dv, dv_keyword, 
                                     subjectwise_mean, group_mean, se,
...
```{r random_effects_2, message=FALSE, warning=TRUE, include=FALSE, paged.print=FALSE}
# test function
...
[ INSERT DESCRIPTION ]
```{r random_cue_scatter_plot_2, echo=FALSE, message=FALSE, warning=TRUE}
...
```{r random_effects_scatter_plot_2, echo=FALSE, message=FALSE, warning=TRUE}
