...
## behavioral :: line plots cue * stim * expect (demean outcome)
Here, I plot the demeaned-outcome rating as a function of cue, stimulus intensity, and expectation interaction. 

```{r, fig.height=10}
# Function to create individual plots
create_individual_plot <- function(data, iv1, iv2, intensity, xlab, ylab, ggtitle, color_scheme, size = 2, subtitle_size, text_size) {
...
roi_combined_plot <- grid.arrange(y_axis_label, x_combined_plot, ncol = 2, widths = c(1, 10))
final_plot <- grid.arrange(roi_combined_plot,
    #x_axis_label,
    legend_grob,
    ncol = 1,
    nrow = 2,
    heights = unit.c(unit(8, "null"), unit(1, "null")),
    top = textGrob(
