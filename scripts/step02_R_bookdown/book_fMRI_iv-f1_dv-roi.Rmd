...
```{r}
data_dir = "/Users/h/Documents/projects_local/cue_expectancy/analysis/fmri/nilearn/deriv06_NPSdecoding"
# load data ____________________________________________________________________
low_fname <- file.path(data_dir, "roi-dACC_cue-low.tsv")
lowdf <- readr::read_tsv(low_fname)
lowdf$cue <- "low cue"
high_fname <- file.path(data_dir, "roi-dACC_cue-high.tsv")
...
df_long <- pivot_longer(
  data = df, 
  cols = c(F1_Class_high, F1_Class_med, F1_Class_low), 
  names_to = "stim", 
  values_to = "f1_value",
  names_prefix = "F1_Class_"
)
...
g <- plot_lineplot_twofactor(f1_groupwise[f1_groupwise$cue_ordered == "high cue",],# taskname = "pain",
                        iv1 = "stim_ordered", iv2 = "cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
                        color = c( "high cue" = "#FF0000"), #"low cue" = "#3E61EC",
...
g <- plot_lineplot_twofactor(f1_groupwise[f1_groupwise$cue_ordered == "low cue",],# taskname = "pain",
                        iv1 = "stim_ordered", iv2 = "cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
