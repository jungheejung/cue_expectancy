...
beta <- read.table(file = file.path(paste0("/Volumes/spacetop_projects_cue/analysis/physio/nobaseline/glm/glm-factorial_task-", taskname, "_scr.tsv")), sep = '\t', header = TRUE)
```
...
taskname <- "pain"
# model_iv2 <- "cue_ordered"
analysis_dir <- file.path(main_dir, "analysis", "mixedeffect", "book_scr")
...
ggsave(file.path(analysis_dir, paste0("SCR_maineffect", as.character(Sys.Date()), ".svg")), dpi=300) 
