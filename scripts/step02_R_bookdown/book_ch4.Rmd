...
g <- plot_lineplot_twofactor(subset, 
                        ...
                        color = c("low cue" = "#3E61EC"), ggtitle = "Within pain task: Outcome rating",
...
g <- plot_lineplot_twofactor(NPSsubset, 
                        iv1 = "stim_ordered", iv2 = "cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
                        color = c("low cue" = "#3E61EC"), ggtitle = paste0("NPS N =", length(unique(NPSstimcue_subjectwise$sub))),
...
g <- plot_lineplot_twofactor(SIIPSsubset, 
                        iv1 = "stim_ordered", iv2 = "cue_ordered",
                        mean = "mean_per_sub_norm_mean", error = "se",
                        color = c("low cue" = "#3E61EC"), ggtitle = paste0("NPS N =", length(unique(SIIPS_subjectwise$sub))),
