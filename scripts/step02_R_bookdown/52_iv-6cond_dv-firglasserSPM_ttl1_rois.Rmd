...
for (roi in c("dACC", "PHG")) {
  ...
  for (run_type in run_types) {
    ...
    # scaling_factor <- min(figure_width, figure_height) / AXIS_FONTSIZE_BASE
    # # Set the text size based on the calculated proportion
    # AXIS_FONTSIZE <- AXIS_FONTSIZE_BASE * scaling_factor
    # COMMONAXIS_FONTSIZE <- COMMONAXIS_FONTSIZE_BASE * scaling_factor
    # TITLE_FONTSIZE <- TITLE_FONTSIZE_BASE * scaling_factor
    # 
    ...
    #  # 
    #  #    font_size_base_dict <- list(
    #  #  AXIS_FONTSIZE_BASE = 20,
    #  #  COMMONAXIS_FONTSIZE_BASE = 15,
    #  #   TITLE_FONTSIZE_BASE = 25
    #  # )
  ...
  #all_plots_for_roi <- plot_list_per_roi
  # ----------------------------------------------------------------------------
  #                  add commom legend
  # ----------------------------------------------------------------------------
