...
plot_halfrainclouds_twofactor(subjectwise, groupwise,
                              ...
                              ylim = c(-50, 50),
                                      w=10, h=6, dv_keyword = "stimulusintensity", color = c( "#1982c4","#ffca3a", "#9a031e"), save_fname = "/Users/h/Desktop/plot_35.png") 
```
...
kableExtra::kable_styling(
  knitr::kable(
    eta_squared(model.npsstim, partial = TRUE), # MODIFY
    "html"), "striped", position = "left", font_size = 12)
```

#### Cohen's d: NPS stimulus_intensity = 1.287 {.unlisted .unnumbered}
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
kableExtra::kable_styling(
  knitr::kable(
    lme.dscore(model.npsstim, data_screen, type = "lme4"), # MODIFY
    "html"), "striped", position = "left", font_size = 12)
```
...
#### Linear model ver 2: Cohen's d: NPS stimulus_intensity d = 1.16, cue d = 0.45 {.unlisted .unnumbered}
```{r echo=FALSE, message=FALSE, warning=TRUE, paged.print=FALSE}
...
plot_lineplot_twofactor(actual_groupwise, taskname = "pain", 
