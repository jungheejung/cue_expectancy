...
print("eta squared")
eta_squared(model.npsstim, partial = TRUE)
parameters::model_parameters(model.npsstim)
lme.dscore(model.npsstim, data_screen, type = "lme4")
#r2mlm(model.nps)
emm1 = emmeans(model.npsstim, specs = pairwise ~ stim_con_linear+ stim_con_quad )
```
...
print("eta squared")
eta_squared(model.npscuestim, partial = TRUE)
...
print("eta squared")
eta_squared(model.nps3factor, partial = TRUE)
#parameters::model_parameters(model.nps3factor)
lme.dscore(model.nps3factor, data_screen, type = "lme4")
```
