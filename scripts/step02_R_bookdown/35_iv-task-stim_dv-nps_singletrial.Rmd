...
model.alltask <- lmer(NPSpos ~ task_V_gt_C*stim_factor + task_P_gt_VC*stim_factor + (task|sub), data = pvc)

sjPlot::tab_model(model.alltask, title = "Multilevel-modeling: \nlmer(NPSpos ~ task_V_gt_C*stim_factor + task_P_gt_VC*stim_factor + (task|sub), data = pvc)")
```
...
plot_lineplot_twofactor_subset(actual_groupwise, taskname = "pain", 
...
model.npscuestim <- lmer(NPSpos ~ CUE_high_gt_low*stim_con_linear + CUE_high_gt_low*stim_con_quad + (CUE_high_gt_low+stim_factor|sub), data = data_screen)
...
model.nps3factor <- lmer(NPSpos ~ CUE_high_gt_low*stim_con_linear*event02_expect_angle + CUE_high_gt_low*stim_con_quad*event02_expect_angle + (CUE_high_gt_low|sub), data = data_screen)
...
library(plotly)
# lmer(NPSpos ~ CUE_high_gt_low*stim_con_linear*event02_expect_angle + CUE_high_gt_low*stim_con_quad*event02_expect_angle + (CUE_high_gt_low|sub), data = data_screen)
...
taskname = "pain"
    ...
    w <- 10
    h <- 6
s1.sig <- df_merge[df_merge$runtype == "runtype-pain" & df_merge$ses == "ses-01",]
data <- s1.sig
    # [ CONTRASTS ]  ________________________________________________________________________________ # nolint
# contrast code ________________________________________
data$stim[data$stimintensity == "low"] <- -0.5 # social influence task
...
taskname = "pain"
    ...
    w <- 10
    h <- 6
s1.sig <- df_merge[df_merge$runtype == "runtype-pain" & df_merge$ses == "ses-03",]
data <- s1.sig
    # [ CONTRASTS ]  ________________________________________________________________________________ # nolint
# contrast code ________________________________________
data$stim[data$stimintensity == "low"] <- -0.5 # social influence task
...
taskname = "pain"
    ...
    w <- 10
    h <- 6
s1.sig <- df_merge[df_merge$runtype == "runtype-pain" & df_merge$ses == "ses-04",]
data <- s1.sig
    # [ CONTRASTS ]  ________________________________________________________________________________ # nolint
# contrast code ________________________________________
data$stim[data$stimintensity == "low"] <- -0.5 # social influence task
...
data$STIM_quadratic[data$stimintensity == "high"] <- -0.33
    ...
    data$SES_1_gt_34[data$ses == "ses-01"] <- .66
    data$SES_1_gt_34[data$ses == "ses-03"] <- -.34
    data$SES_1_gt_34[data$ses == "ses-04"] <- -.34

    # contrast code 2 quadratic
    data$SES_3_gt_4[data$ses == "ses-01"] <- 0
    data$SES_3_gt_4[data$ses == "ses-03"] <- .5
    data$SES_3_gt_4[data$ses == "ses-04"] <- -.5
...
model.npssescuestim <- lmer(NPSpos ~ CUE_high_gt_low*STIM_linear*SES_3_gt_4 + CUE_high_gt_low*STIM_quadratic*SES_3_gt_4 + CUE_high_gt_low*STIM_linear*SES_1_gt_34 + CUE_high_gt_low*STIM_quadratic*SES_1_gt_34 + (CUE_high_gt_low|sub), data = data)
