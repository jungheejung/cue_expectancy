...
# Stim P > VC
p.fname = '/Volumes/spacetop_projects_social/analysis/fmri/spm/univariate/model-02_CcEScA/extract_nps/model-02_CcEScA/model-02_CcEScA_con_0009.csv'
# Stim P > VC
v.fname = '/Volumes/spacetop_projects_social/analysis/fmri/spm/univariate/model-02_CcEScA/extract_nps/model-02_CcEScA/model-02_CcEScA_con_0010.csv'
c.fname = '/Volumes/spacetop_projects_social/analysis/fmri/spm/univariate/model-02_CcEScA/extract_nps/model-02_CcEScA/model-02_CcEScA_con_0011.csv'
...
guides(color = FALSE) +
guides(fill = guide_legend(title = title)) +
scale_x_discrete(labels=c("cognitive_gt_PV" = "Cognitive > PV", 
                              "pain_gt_VC" = "Pain > VC", 
                              "vicarious_gt_PC" = "Vicarious > PC")) +
