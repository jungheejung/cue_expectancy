...
```
```{r}
meta.P.df = load_task_social_df("pain", "sub","stim","sub-0001" )
...
meta.V.df = load_task_social_df("vicarious", "sub","stim","sub-0001" )
...
meta.C.df = load_task_social_df("cognitive", "sub","stim","sub-0001" )
